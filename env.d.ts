/* eslint-disable */
// Generated by Wrangler by running `wrangler types env.d.ts` (hash: 9a01ba2e425ab9bcd9a16d61c2283715)
...
interface __BaseEnv_Env {
	...
	IncidentPilotAgent: DurableObjectNamespace<import("./src/index").IncidentPilotAgent>;
	INCIDENT_REMEDIATION_WORKFLOW: Workflow<Parameters<import("./src/index").IncidentRemediationWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "IncidentPilotAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CONTEXT_SEQUENCE_WIDTH" | "LOG_LEVEL" | "CONTEXT_ID_PREFIX">> {}
}
